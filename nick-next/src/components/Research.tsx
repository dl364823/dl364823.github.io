...
const CARD_CLASS = "relative mx-auto w-full max-w-md h-[220px] p-4 bg-gradient-to-br from-white/10 via-blue-900/20 to-purple-900/20 backdrop-blur-xl rounded-[2rem] shadow-2xl border border-white/10 transition-all duration-300 hover:scale-103 hover:shadow-[0_8px_32px_0_rgba(31,38,135,0.32)] hover:border-blue-400/40 group focus:outline-none";
...
const Research: React.FC<ResearchProps> = ({ inputData, title }) => {
  ...
  return (
    <div className="w-full max-w-5xl mx-auto py-8">
      {/* Card */}
      <div
        className={`overflow-y-auto scrollbar-thin scrollbar-thumb-[#222]/70 scrollbar-track-transparent px-1`}
        style={{
          height: `${CARD_HEIGHT + GAP_Y}px`, 
        }}
      >
